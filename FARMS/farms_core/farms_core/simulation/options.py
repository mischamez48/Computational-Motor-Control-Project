...
class SimulationOptions(Options):
    ...
    def __init__(self, **kwargs):
        ...
        # Camera
        self.camera_id: int = kwargs.pop('camera_id', 0)
        ...
        self.record_path: str = kwargs.pop('record_path', '')
    ...
    def with_clargs(cls, **kwargs):
        ...
        return cls(
            ...
            # Camera
            camera_id=kwargs.pop('camera_id', clargs.camera_id),
            ...
            record_path=kwargs.pop('record_path', clargs.record_path),
