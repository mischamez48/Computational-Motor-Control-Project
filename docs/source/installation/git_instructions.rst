...
the CMC-2025 exercises using Git. It is not a comprehensive tutorial on
...
3.  Then execute the following command to clone the repository:
    ...
    .. code:: bash
              ...
              $ git clone https://gitlab.com/farmsim/courses/cmc-2025-students.git

   This would clone the repository with the default folder name
   ``cmc-2025-students``. If you wish to clone with a different folder name, then use
   the following command and replace ``FOLDER_NAME`` with the name of
   the folder you want to clone into:

   .. code:: bash

             $ git clone https://gitlab.com/farmsim/courses/cmc-2025-students.git FOLDER_NAME
